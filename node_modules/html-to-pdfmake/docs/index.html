...
<body>
  ...
  <div>
    <textarea style="height:40vh;width:100%" id="code">
&lt;div>
  &lt;h1>My title&lt;/h1>
  &lt;p>
...
&lt;/div>
  ...
  <div><button type="button" onclick="convert()">Convert</button></div>
  <p>Result:</p>
  <div style="display:flex">
    <textarea id="result" style="flex:1;height:40vh"></textarea>
    <iframe id="pdf" style="flex:1;height:40vh"></iframe>
  </div>
  ...
  <script>
    function convert () {
      var val = htmlToPdfmake(document.querySelector('#code').value);
